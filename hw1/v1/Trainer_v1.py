...
from my_model_v1 import NerModel
from dataset_v1 import NerDataset
from Params_v1 import Params
    ...
    def train(self,
        ...
        for epoch in range(epochs):
            ...
            for step, sample in enumerate(train_dataset):
                ...
                pos_tag = sample['pos_tag'].to(self.device)
                self.optimizer.zero_grad()

                predictions = self.model(inputs, pos_tag)
...
if __name__ == '__main__':
    ...
    POS_MODEL_PATH = '../../../model/en_core_web_sm-3.2.0'
    DEVICE = 'cuda:0'

    # create Dataset

    dataset = NerDataset(TRAIN_PATH, POS_MODEL_PATH)
    devset = NerDataset(DEV_PATH, POS_MODEL_PATH)
    # create Vocab
    ...
    params = Params(vocab_size=len(dataset.vocab),
                    ...
                    pos_size=len(dataset.vocab_pos))
    ...
    torch.save(ner_model.state_dict(), '../../../model/model_weights/700NO_STOP.pth')
